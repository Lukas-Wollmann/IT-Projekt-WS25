...
bool ControlFlowPass::visit(const ast::IntLit &) { return false; }
bool ControlFlowPass::visit(const ast::FloatLit &) { return false; }
bool ControlFlowPass::visit(const ast::CharLit &) { return false; }
bool ControlFlowPass::visit(const ast::BoolLit &) { return false; }
bool ControlFlowPass::visit(const ast::StringLit &) { return false; }
bool ControlFlowPass::visit(const ast::ArrayExpr &) { return false; }
bool ControlFlowPass::visit(const ast::UnaryExpr &) { return false; }
bool ControlFlowPass::visit(const ast::BinaryExpr &) { return false; }
bool ControlFlowPass::visit(const ast::FuncCall &) { return false; }
bool ControlFlowPass::visit(const ast::VarRef &) { return false; }
bool ControlFlowPass::visit(const ast::VarDef &) { return false; }
