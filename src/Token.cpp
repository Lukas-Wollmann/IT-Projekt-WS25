...
std::ostream &operator<<(std::ostream &os, ErrorTypeToken type)
{
    switch (type)
    {
		...
		case ErrorTypeToken::SOLO_BACKSLASH_IN_CHAR_LITERAL: return os << "SOLO_BACKSLASH_IN_CHAR_LITERAL";
		case ErrorTypeToken::INVALID_ESCAPE_SEQUENCE: return os << "INVALID_ESCAPE_SEQUENCE";
		case ErrorTypeToken::MULTIPLE_CHAR_IN_CHAR_LITERAL: return os << "MULTIPLE_CHAR_IN_CHAR_LITERAL";
